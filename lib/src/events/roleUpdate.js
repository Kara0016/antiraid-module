...
class default_1 {
    ...
    run(oldRole, newRole) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!oldRole || !oldRole.guild || !oldRole.guild.hasOwnProperty("fetchAuditLogs"))
                return;
            oldRole.guild.fetchAuditLogs({
                type: "ROLE_UPDATE"
            }).then(audit => audit.entries.first()).then((entry) => __awaiter(this, void 0, void 0, function* () {
                if (oldRole.id !== entry.target.id)
                    return;
                let member = yield oldRole.guild.members.fetch(entry.executor.id).catch(() => null);
