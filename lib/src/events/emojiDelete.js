...
class default_1 {
    ...
    run(emoji) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!emoji || !emoji.guild || !emoji.guild.hasOwnProperty("fetchAuditLogs"))
                return;
            emoji.guild.fetchAuditLogs({
                type: "EMOJI_DELETE"
            }).then(audit => audit.entries.first()).then((entry) => __awaiter(this, void 0, void 0, function* () {
                if (emoji.id !== entry.target.id)
                    return;
                let member = yield emoji.guild.members.fetch(entry.executor.id).catch(() => null);
